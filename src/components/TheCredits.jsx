function TheCredits() {
    ...
    <>
        ...
        Challenge by 
            ...
            Coded by 
            <a
                className="flex gap-x-1 font-bold group hover:text-Very-dark-violet"
                aria-label='Go to Victoria Azola Github' 
                target="_blank" 
                href="https://github.com/VickyAzola/Interactive-card-details-form" 
                rel="noreferrer"
            >
                <svg
                    className="w-4 h-4 fill-gray-400 group-hover:fill-Very-dark-violet" 
